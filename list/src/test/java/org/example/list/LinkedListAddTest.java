...
public class LinkedListAddTest {
    ...
    void addNullElement() {
        ...
        linkedList.add(element);
        // Assert
        assertEquals(1, linkedList.size(), "Size should be 1 after adding null element");
    ...
    void addElementWithSpecialCharacters() {
        ...
        assertEquals("café", linkedList.get(2), "Third element with unicode should match");
        assertEquals("🎉emoji", linkedList.get(3), "Fourth element with emoji should match");
    }
    @Test
    @Tag("valid")
    ...
    void addVariousStringElements(String element) {
        ...
        // Assert
        assertEquals(1, linkedList.size(), "Size should be 1");
        assertEquals(element, linkedList.get(0), "Element should be stored at index 0");
    }
    @Test
    @Tag("valid")
